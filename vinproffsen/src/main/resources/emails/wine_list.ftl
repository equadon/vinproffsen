...
<head>
    ...
    <title>Din Vinlista - VinProffsen</title>
    ...
    ul.wine-info li { list-style: none; }
    small { color: #555; }
  </style>
</head>
<body>
    ...
    <#list wines as wine>
        <li>
            <div class="wine">
                <h2>${wine.fullName} (${wine.year?c}) <small>${wine.type}</small></h2>

                <ul class="wine-info">
                    <li>Pris: <b>${wine.price / 100}:-</b></li>
                    <li>Från: <b>${wine.from}</b></li>
                    <li>Volym: <b>${wine.volume} ml</b></li>
                    <li>Alkoholhalt: <b>${wine.alcohol?string.percent}</b></li>
                    <li>
                        Ytterligare info:
                        <ul class="wine-options">
                            <li>
                                Ekologiskt: 
                                <#if wine.ecological>
                                    Ja                            
